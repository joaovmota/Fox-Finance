...
export function Modal({ title, children, onClose }) { return <div className="fox-modal-backdrop" role="presentation"><div className="fox-modal" role="dialog" aria-modal="true" aria-labelledby="modal-title" data-testid="placeholder-modal"><div className="fox-modal-header"><h2 id="modal-title">{title}</h2><IconButton label="Fechar" onClick={onClose} data-testid="modal-close-button"><X size={18} /></IconButton></div>{children}</div></div>; }